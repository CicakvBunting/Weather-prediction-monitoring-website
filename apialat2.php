...
$query = "INSERT INTO test_prediksi (solarirradiance,relativetemperature,relativehumidity,windspeed,surfacetemperaturearray,voltage,current) VALUES ('$solar', '$temp','$humi','$wind','$surtem','$voltage','$current')";
